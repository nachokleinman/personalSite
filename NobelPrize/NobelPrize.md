...
display(len(nobel[(1901 <= nobel['year']) & (nobel['year']< 2016)]))
...
```
    ...
    <seaborn.axisgrid.FacetGrid at 0x7fcaaa082160>
...
```
    ...
    <seaborn.axisgrid.FacetGrid at 0x7fca10f57fd0>
